...
namespace BNR
{
    internal static class BNRPayloadProvider
    {
        ...
        internal static BNRPayload ProvideBNRPayload()
        {
            ...
            using (EdgeDriver driver = new EdgeDriver(new EdgeOptions { UseChromium = true }))
            {
                ...
                for (int index = 0; index < dailyIndexElements.Count; index += 2)
                {
                    ...
                    dailyIndices.Add(new DailyIndex
                    {
                        ...
                        IndexPercentage = decimal.Parse(value),
                    });
                }
